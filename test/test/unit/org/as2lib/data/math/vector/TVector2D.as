 ...
 */
class test.unit.org.as2lib.data.math.vector.TVector2D extends TestCase {
	...
	public function testConstructor(Void):Void {
		...
		assertUndefined("Vector.get(2) should return undefined.", vector.getValue(2));
	...
	public function testSetX(Void):Void {
		...
		vector.setX(22);
		assertSame("Vector.getValue(0) should return 22.", vector.getX(), 22);
	...
	public function testSetY(Void):Void {
		var vector:Vector2D = new Vector2D();
		vector.setY(34);
		assertSame("Vector.getValue(1) should return 34.", vector.getY(), 34);
	}

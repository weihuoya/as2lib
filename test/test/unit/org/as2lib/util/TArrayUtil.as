...
class test.unit.org.as2lib.util.TArrayUtil extends TestCase {
	...
	public function testContains(Void):Void {
		...
		assertTrue("Test should contain 1", ArrayUtil.contains(1));
		
		// Test if it contains the last element
		assertTrue("Test should contain 5", ArrayUtil.contains(5));
		
		// Test if it contains a middle element
		assertTrue("Test should contain 3", ArrayUtil.contains(3));
		
		// Test if it contains a non existant element
		assertFalse("Test should not contain 6", ArrayUtil.contains(6));
	}

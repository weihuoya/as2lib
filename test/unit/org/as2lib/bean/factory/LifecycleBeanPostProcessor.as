 ...
 * @author Simon Wacker
 */
class org.as2lib.bean.factory.LifecycleBeanPostProcessor extends BasicClass implements BeanPostProcessor {
	
	public function postProcessBeforeInitialization(bean, name:String) {

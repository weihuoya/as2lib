 ...
 * @author Simon Wacker
 */
class org.as2lib.env.event.distributor.TSimpleEventDistributorControl extends AbstractTEventDistributorControl {
	
	private function getEventDistributorControl(listenerType:Function):EventDistributorControl {
		return new SimpleEventDistributorControl(listenerType);
	}
	
	public function testNewWithNullArgument(Void):Void {
		try {
			getEventDistributorControl(null);

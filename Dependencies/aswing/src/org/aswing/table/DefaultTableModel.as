...
class org.aswing.table.DefaultTableModel extends AbstractTableModel {
    ...
    /** The <code>Array</code> of column identifiers. */
    private var    columnIdentifiers:Array;
    ...
    public function initWithNamesRowcount(columnNames:Array, rowCount:Number):DefaultTableModel {
        setDataArray(new Array(rowCount), columnNames);
        return this;
    }
     ...
     * @see #getDataArray()
     */
    public function setDataArray(dataArray:Array, columnIdentifiers:Array):Void {
     ...
     * @see #setNumRows()
     */
    public function setColumnIdentifiers(columnIdentifiers:Array):Void {
    ...
    public function setColumnCount(columnCount:Number):Void { 
    	ArrayUtils.setSize(columnIdentifiers, columnCount);
		justifyRows(0, getRowCount()); 
		fireTableStructureChanged();
    } 
    ...
    public function getColumnName(column:Number):String {
		...
		if (column < columnIdentifiers.length) {  
     ...
     */
    public function setCellEditable(column:Number, editable:Boolean):Void{

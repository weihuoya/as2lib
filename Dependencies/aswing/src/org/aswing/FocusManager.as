...
class org.aswing.FocusManager{
	...
	public function FocusManager(){
		...
		focusFrontHolderMC = _root.createEmptyMovieClip("aswing_focusFrontHolderMC", _root.getNextHighestDepth());
		focusFrontHolderMC.onPress = function(){};
		focusFrontHolderMC.tabEnabled = true;
		focusFrontHolderMC.tabIndex = ASWING_TAB_INDEX_START;
		focusBackHolderMC = _root.createEmptyMovieClip("aswing_focusBackHolderMC", _root.getNextHighestDepth());

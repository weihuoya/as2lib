...
/**
 * Note: All empty object should be undefined.
 * Undefined means not set, if it is null, means that user set it to be null, so LAF value will not be use. 
 * @author iiley
 */
class org.aswing.plaf.basic.BasicLookAndFeel extends LookAndFeel{
	...
	private function initComponentDefaults(table:UIDefaults):Void{
	   ...
	   // *** JToolTip
        ...
        "List.itemSelectedBackground", new ASColorUIResource(0x444444),
	    ...
	    "ToolBar.buttonBorder", org.aswing.plaf.basic.border.ToolBarButtonBorder
	    ];
	    table.putDefaults(comDefaults);
	    ...
	    // *** Separator
	    comDefaults = [
	    "Separator.background", new ASColorUIResource(0xcccccc),

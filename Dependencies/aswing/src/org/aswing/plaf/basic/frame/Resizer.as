...
import org.aswing.plaf.basic.frame.ResizeBarHandler;
import org.aswing.plaf.basic.frame.ResizeStrategy;
import org.aswing.plaf.basic.frame.ResizeStrategyImp;
 ...
 * @author iiley
 */
class org.aswing.plaf.basic.frame.Resizer implements org.aswing.Resizer, UIResource{
	...
	public function setOwner(c:Component):Void{
		...
		com = c;
		listener = com.addEventListener(Component.ON_PAINT, locate, this);
	}
	...
	private function createResizeMCs(mc:MovieClip):Void{
		...
		resizeMC = creater.createMC(mc, "resizeMC");
		...
		ResizeBarHandler.createHandler(this, topResizeMC, 90, new ResizeStrategyImp(0, -1));
		ResizeBarHandler.createHandler(this, leftResizeMC, 0, new ResizeStrategyImp(-1, 0));
		ResizeBarHandler.createHandler(this, rightResizeMC, 0, new ResizeStrategyImp(1, 0));
		ResizeBarHandler.createHandler(this, bottomResizeMC, 90, new ResizeStrategyImp(0, 1));
		
		ResizeBarHandler.createHandler(this, topLeftResizeMC, 45, new ResizeStrategyImp(-1, -1));
		ResizeBarHandler.createHandler(this, topRightResizeMC, -45, new ResizeStrategyImp(1, -1));
		ResizeBarHandler.createHandler(this, bottomLeftResizeMC, -45, new ResizeStrategyImp(-1, 1));
		ResizeBarHandler.createHandler(this, bottomRightResizeMC, 45, new ResizeStrategyImp(1, 1));

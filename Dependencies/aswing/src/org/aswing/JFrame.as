...
class org.aswing.JFrame extends JWindow {
	...
	/**
	 * Call this method tring to close the Frame depend on the <code>defaultCloseOperation</code>
	 */
	...
	public function createDragRepresentMC():MovieClip{
		return creater.createMC(root_mc, "drag_mc");
	}
}

...
class org.aswing.UIDefaults extends HashMap{
	...
	public function getInstance(key:String):Object{
		...
		if(value instanceof Function){
			return getCreateInstance(Function(value));
		}else{
			return value;
		}
	}
	
	private function getCreateInstance(constructor:Function):Object{
		var instance:Object = constructor[CREATE_METHOD_NAME]();
		if(instance == null){

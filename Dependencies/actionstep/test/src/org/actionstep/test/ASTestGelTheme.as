...
class org.actionstep.test.ASTestGelTheme {
	public static function test():Void {		
		var btn:MovieClip = createGelButton(new NSSize(100, 25), 0x990000);
		btn._x = btn._y = 10;
		
		var btn2:MovieClip = createGelButton(new NSSize(25, 25), 0x009900);
		btn2._y = 10;
		btn2._x = 115;
		
		var btn3:MovieClip = createGelButton(new NSSize(30, 50), 0x000099);
		btn3._y = 40;
		btn3._x = 10;		
	}

...
class org.actionstep.test.ASTestButtonTypes {
	...
	public static function test() {
		...
		grid.putViewAtRowColumnWithMargins(btn5, 2, 0, 3);
		...
		grid.putViewAtRowColumnWithMargins(btn6, 2, 1, 3);
		...
		grid.putViewAtRowColumnWithMargins(btn7, 3, 0, 3);
		...
		grid.putViewAtRowColumnWithMargins(btn8, 3, 1, 3);
		...
		grid.putViewAtRowColumnWithMargins(btn9, 4, 0, 3);
		...
		grid.putViewAtRowColumnWithMargins(btn10, 4, 1, 3);
		...
		btn11.setTag(44);
		grid.putViewAtRowColumnWithMargins(btn11, 5, 0, 3);

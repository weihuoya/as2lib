...
{	
	...
	private static function initialize():Void
	{
		...
		g_arrowCursor = (new NSCursor()).initWithImageHotSpot(
			NSImage.imageNamed("NSArrowCursorRep"), NSPoint.ZeroPoint);			

		g_systemArrowCursor = NSCursor((new ASSystemArrowCursor()).init());		
		
		sz = NSImage.imageNamed("NSCrosshairCursorRep")
			.bestRepresentationForDevice().size();
		g_crosshairCursor = (new NSCursor()).initWithImageHotSpot(
			NSImage.imageNamed("NSCrosshairCursorRep"), 
			new NSPoint(sz.width / 2, sz.height / 2));		
			
		sz = NSImage.imageNamed("NSResizeLeftCursorRep")
			.bestRepresentationForDevice().size();
		g_resizeLeftCursor = (new NSCursor()).initWithImageHotSpot(
			NSImage.imageNamed("NSResizeLeftCursorRep"), 
			new NSPoint(sz.width / 2, sz.height / 2));	
			
		sz = NSImage.imageNamed("NSResizeLeftRightCursorRep")
			.bestRepresentationForDevice().size();
		g_resizeLeftRightCursor = (new NSCursor()).initWithImageHotSpot(
			NSImage.imageNamed("NSResizeLeftRightCursorRep"), 
			new NSPoint(sz.width / 2, sz.height / 2));	
		
		sz = NSImage.imageNamed("NSResizeRightCursorRep")
			.bestRepresentationForDevice().size();	
		g_resizeRightCursor = (new NSCursor()).initWithImageHotSpot(
			NSImage.imageNamed("NSResizeRightCursorRep"), 
			new NSPoint(sz.width / 2, sz.height / 2));	
			
		sz = NSImage.imageNamed("NSResizeDownCursorRep")
			.bestRepresentationForDevice().size();
		g_resizeDownCursor = (new NSCursor()).initWithImageHotSpot(
			NSImage.imageNamed("NSResizeDownCursorRep"), 
			new NSPoint(sz.width / 2, sz.height / 2));	

		sz = NSImage.imageNamed("NSResizeUpCursorRep")
			.bestRepresentationForDevice().size();
		g_resizeUpCursor = (new NSCursor()).initWithImageHotSpot(
			NSImage.imageNamed("NSResizeUpCursorRep"), 
			new NSPoint(sz.width / 2, sz.height / 2));	

		sz = NSImage.imageNamed("NSResizeUpDownCursorRep")
			.bestRepresentationForDevice().size();
		g_resizeUpDownCursor = (new NSCursor()).initWithImageHotSpot(
			NSImage.imageNamed("NSResizeUpDownCursorRep"), 
			new NSPoint(sz.width / 2, sz.height / 2));	
		
		sz = NSImage.imageNamed("NSResizeDiagonalUpCursorRep")
			.bestRepresentationForDevice().size();
		g_resizeDiagonalUpCursor = (new NSCursor()).initWithImageHotSpot(
			NSImage.imageNamed("NSResizeDiagonalUpCursorRep"), 
			new NSPoint(sz.width / 2, sz.height / 2));
						
		sz = NSImage.imageNamed("NSResizeDiagonalDownCursorRep")
			.bestRepresentationForDevice().size();
		g_resizeDiagonalDownCursor = (new NSCursor()).initWithImageHotSpot(
			NSImage.imageNamed("NSResizeDiagonalDownCursorRep"), 
			new NSPoint(sz.width / 2, sz.height / 2));		
			
//		g_closedHandCursor = (new NSCursor()).initWithImageHotSpot(
//			NSImage.imageNamed("NSClosedHandCursorRep"), NSPoint.ZeroPoint);	
...
//			NSImage.imageNamed("NSIBeamCursorRep"), NSPoint.ZeroPoint);	
//		g_openHandCursor = (new NSCursor()).initWithImageHotSpot(
//			NSImage.imageNamed("NSOpenHandCursorRep"), NSPoint.ZeroPoint);	

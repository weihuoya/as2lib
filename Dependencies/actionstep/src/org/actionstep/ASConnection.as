 ...
 */
class org.actionstep.ASConnection extends NSObject {
	 ...
	 * 
	 * This method raises an <code>NSException</code> if a connection already
	 * exists for the URL <code>url</code>.
	 */
	public function initWithURL(url:String):ASConnection {
		...
		if (null != url && hasConnectionForURL(url)) {
			var e:NSException = NSException.exceptionWithNameReasonUserInfo(
				...
				"A connection already exists with the URL " + url,
				null);
			trace(e);
			throw e;
		}
	 ...
	 */
	public function call(remoteMethod:String, responder:Object
			/*, ...*/):Void {
		m_connection.call.apply(m_connection, arguments);
	}

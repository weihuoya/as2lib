...
?>            <div class="contentArea">
              ...
              <div class="hr"></div>
              <div class="text">
                <p><?php comments_rss_link('<abbr title="Really Simple Syndication">RSS</abbr> feed for comments on this post.'); ?></p><?php
    if ('open' == $post->ping_status) { ?>

                <p>The <acronym title="Uniform Resource Identifier">URI</acronym> to TrackBack this entry is: <em><?php trackback_url() ?></em></p><?php 
    } 
    if ($comments) { ?>
    ...
    ?>
                ...
                <p>No comments yet.</p><?php
    } 
    ?>

              </div>
            </div>
            <div class="contentArea" id="weblogNewComment">
              <h2>Leave a Comment</h2>
              <div class="hr" ></div>
              <div class="text"><?php if ('open' == $post->comment_status) { ?>
    ...
    ?>
                  ...
                  <p><strong>Please note:</strong> Comment moderation is currently enabled so there may be a delay between when you post your comment and when it shows up. Patience is a virtue; there&#8217;s no need to resubmit your comment.</p><?php
    } // comment_moderation != 'none'
    ?>

                  <input class="button" name="submit" type="submit" tabindex="5" value="Submit your comment" />
                </form><?php
  } else { // comments are closed ?>
                <p>Sorry, comments are closed at this time.</p><?php
  } 

 ...
 * @author Simon Wacker
 */
class org.as2lib.env.bean.PropertyValueConverterHolder extends BasicClass {
	...
	public function getPropertyValueConverter(requiredType:Function):PropertyValueConverter {
		if (!registeredType || !requiredType || ClassUtil.isSubClassOf(requiredType, registeredType) || ClassUtil.isImplementationOf(requiredType, registeredType)) {

...
/**
 * {@code Log4fLogger} delegates all messages to the {@code Log4f.log} method of
 * the Log4f project.
 * 
 ...
 *
 * @author Simon Wacker
 * @see org.as2lib.env.log.handler.Log4fHandler
...
class org.as2lib.env.log.logger.Log4fLogger extends BasicClass implements Logger {
	...
	/** Log4f class reference for fast access. */
	private var log4f:Function;
	 ...
	 */
	public function Log4fLogger(level:Number) {
		setLevel(level);
		this.log4f = Log4f;
	...
	public function debug(message):Void {
		if (isDebugEnabled()) {
			this.log4f.log(this.debugLevel, message, "");
		}
	}
	...
	public function info(message):Void {
		if (isInfoEnabled()) {
			this.log4f.log(this.infoLevel, message, "");
		}
	}
	...
	public function warning(message):Void {
		if (isWarningEnabled()) {
			this.log4f.log(this.warnLevel, message, "");
		}
	}
	...
	public function error(message):Void {
		if (isErrorEnabled()) {
			this.log4f.log(this.errorLevel, message, "");
		}
	}
	...
	public function fatal(message):Void {
		if (isFatalEnabled()) {
			this.log4f.log(this.fatalLevel, message, "");
		}
	}

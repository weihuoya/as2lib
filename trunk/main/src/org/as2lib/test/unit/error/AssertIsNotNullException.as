 ...
 */
class org.as2lib.test.unit.error.AssertIsNotNullException extends BasicClass implements AssertException {
	 ...
	 */
	public function AssertIsNotNullException (message:String, wrongVar) {

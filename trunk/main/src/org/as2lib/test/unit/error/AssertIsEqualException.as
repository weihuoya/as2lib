 ...
 */
class org.as2lib.test.unit.error.AssertIsEqualException extends Exception implements AssertException {
	/** Stringifier for the TestCase */
	private static var stringifier:Stringifier = new AssertIsEqualStringifier();
	 ...
	 */
	public function AssertIsEqualException (message:String, mainVar, comparedVar, thrower, args:FunctionArguments) {

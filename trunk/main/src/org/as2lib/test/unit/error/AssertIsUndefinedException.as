...
import org.as2lib.test.unit.stringifier.AssertIsUndefinedStringifier;
 ...
 */
class org.as2lib.test.unit.error.AssertIsUndefinedException extends Exception implements AssertException {
	/** Stringifier for the TestCase */
	private static var stringifier:Stringifier = new AssertIsUndefinedStringifier();
	 ...
	 * @param wrongVar	Variable that was not undefined.
	 */
	public function AssertIsUndefinedException (message:String, thrower, arguments:FunctionArguments, wrongVar) {
	...
	/**
	 * Returns the value that was not undefined.
	 * 

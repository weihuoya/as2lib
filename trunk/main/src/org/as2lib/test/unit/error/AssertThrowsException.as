 ...
 */
class org.as2lib.test.unit.error.AssertThrowsException extends BasicClass implements AssertException {
	 ...
	 */
	public function AssertThrowsException (error, message:String) {
		this.error = error;

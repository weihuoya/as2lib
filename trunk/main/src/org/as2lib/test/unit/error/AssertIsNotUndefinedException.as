...
import org.as2lib.test.unit.stringifier.AssertIsNotUndefinedStringifier;
 ...
 */
class org.as2lib.test.unit.error.AssertIsNotUndefinedException extends Exception implements AssertException {
	/** Stringifier for the TestCase */
	private static var stringifier:Stringifier = new AssertIsNotUndefinedStringifier();
		
	/**
	 * Constructs a new AssertUndefined exception.
	 * 
	 ...
	 */
	public function AssertIsNotUndefinedException (message:String, thrower, arguments:FunctionArguments) {

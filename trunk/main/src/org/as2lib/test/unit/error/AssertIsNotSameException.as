...
import org.as2lib.test.unit.stringifier.AssertIsNotSameStringifier;
 ...
 */
class org.as2lib.test.unit.error.AssertIsNotSameException extends Exception implements AssertException {
	/** Stringifier for the TestCase */
	private static var stringifier:Stringifier = new AssertIsNotSameStringifier();
	...
	/**
	 * Constructs a new AssertIsNotSameException.
     *
	 ...
	 */
	public function AssertIsNotSameException (message:String, mainVar, comparedVar, thrower, args:FunctionArguments) {

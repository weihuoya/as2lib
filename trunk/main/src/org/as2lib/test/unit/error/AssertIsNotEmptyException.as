...
import org.as2lib.test.unit.stringifier.AssertIsNotEmptyStringifier;
import org.as2lib.util.string.Stringifier;

/**
 * @autor Martin Heidegger.
 */
class org.as2lib.test.unit.error.AssertIsNotEmptyException extends Exception implements AssertException {
	/** Stringifier for the TestCase */
	private static var stringifier:Stringifier = new AssertIsNotEmptyStringifier();
	
	/**
	 * Constructs a new AssertIsNotEmpty exception.
	 * 
	 ...
	 */
	public function AssertIsNotEmptyException (message:String, thrower, arguments:FunctionArguments) {

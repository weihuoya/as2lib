...
/**
 * Interface for each EventInformation used by the TestRunner.
 * 
...
interface org.as2lib.test.unit.TestRunnerInfo extends EventInfo {
	...
	/**
	 * Getter for the TestRunner where the event was fired.
	 * 
	 * @return TestRunner where the event was fired.
	 */

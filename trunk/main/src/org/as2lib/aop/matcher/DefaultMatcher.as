 ...
 * @author Simon Wacker
 */
class org.as2lib.aop.matcher.DefaultMatcher extends BasicClass implements Matcher {
	
	/**
	 * Constructs a new DefaultMatcher instance.
	 */
	public function DefaultMatcher(Void) {
	}

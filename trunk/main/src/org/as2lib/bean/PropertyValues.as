...
class org.as2lib.bean.PropertyValues extends BasicClass {
	 ...
	 * just be added.
	 * 
	 * <p>If {@code mergeOrOverride} is not defined, {@code true} will be used if this
	 * instance has 0 or 1 property value with the same name, otherwise {@code false}.
	 * 
	 * @param propertyValue the property value to add
	 * @param mergeOrOverride enables or disables merging or overriding
	 */

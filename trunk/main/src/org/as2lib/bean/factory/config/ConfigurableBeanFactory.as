...
/** 
 * {@code ConfigurableBeanFactory} shall be implemented by most bean factories. It
 * provides facilities to configure a bean factory, in addition to the bean factory
 * client methods in the {@code BeanFactory} interface.
 * 
 ...
 * @author Simon Wacker
 */
interface org.as2lib.bean.factory.config.ConfigurableBeanFactory extends BeanFactory {

 ...
 * @author Simon Wacker
 */
class org.as2lib.sample.filebrowser.control.NextFileListener extends BasicClass implements ReleaseListener {
	
	private var scene:Scene;
	
	public function NextFileListener(Void) {
	}

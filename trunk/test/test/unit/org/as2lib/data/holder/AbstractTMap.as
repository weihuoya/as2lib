...
class test.unit.org.as2lib.data.holder.AbstractTMap extends TestCase {
	...
	public function parameterizedTestContainsKey(map:Map):Void {
	...
	public function parameterizedTestContainsValue(map:Map):Void {
	...
	public function parameterizedTestGetKeys(map:Map):Void {
	...
	public function parameterizedTestGetValues(map:Map):Void {
	...
	public function parameterizedTestGet(map:Map):Void {
	...
	public function parameterizedTestPut(map:Map):Void {
		// Has already been tested in parameterizedTestGet(Void):Void.
	}
	
	public function parameterizedTestPutAll(map:Map, target:Map):Void {
		map.putAll(target);
		assertSame("Map.get('key') should return 'stringKey'.", map.get("key"), "stringKey");
		assertSame("Map.get(12) should return 15.", map.get(12), 15);
		assertSame("Map.get(true) should return false.", map.get(true), false);
	...
	public function parameterizedTestRemove(map:Map):Void {
		map.remove("key");
		map.remove(12);
		map.remove(true);
	...
	public function parameterizedTestClear(map:Map):Void {
		map.clear();
		assertFalse("Map.containsKey('key') should return false.", map.containsKey("key"));
		assertFalse("Map.containsKey(12) should return false.", map.containsKey(12));
		assertFalse("Map.containsKey(true) should return false.", map.containsKey(true));
	...
	public function parameterizedTestSize(map:Map):Void {

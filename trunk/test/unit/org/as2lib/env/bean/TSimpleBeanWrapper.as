 ...
 * @author Simon Wacker
 */
class org.as2lib.env.bean.TSimpleBeanWrapper extends TestCase {
	...
	public function testSetPropertyValueWithClassType(Void):Void {
		...
		bw.setPropertyValue(new PropertyValue(SimpleBeanWrapper.PROPERTY_PREFIX + "property", "org.as2lib.env.bean.TSimpleBeanWrapper", Function));
		assertSame("2", wo.property, org.as2lib.env.bean.TSimpleBeanWrapper);
		bw.setPropertyValue(new PropertyValue(SimpleBeanWrapper.PROPERTY_PREFIX + "property", "org.as2lib.NotExistingClass", Function));

 ...
 * @author Simon Wacker
 */
class org.as2lib.aop.advice.TDynamicAfterThrowingAdvice extends AbstractTAdvice {
	
	private function createAdvice(p:Pointcut, c:Call):Advice {
		return new DynamicAfterThrowingAdvice(p, c);
	}
	...
	public function testGetProxyWithProperlyReturningJoinPoint(Void):Void {
		...
		var c:Call = new Call(this, function(joinPoint:JoinPoint, throwable):String {
			z.push("callback");

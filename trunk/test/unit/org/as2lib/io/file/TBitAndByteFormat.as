...
class org.as2lib.io.file.TBitAndByteFormat extends TestCase {
	...
	public function setUp(Void):Void {
		byteFormat = new ByteFormat(1234);
		bitFormat = new BitFormat(1234*8);
	}
	...
	public function testSpecialFloatingPoints(Void):Void {
		...
		assertEquals("testing .getGigaBytes method using 2 comma positions", byteFormat.getGigaBytes(2), 0);

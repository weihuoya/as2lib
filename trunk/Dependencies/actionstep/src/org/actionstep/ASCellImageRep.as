...
class org.actionstep.ASCellImageRep extends NSImageRep 
{
	...
	public function draw():Boolean {
		...
		//
		var clip:MovieClip;
		var level:Number = m_drawClip.getNextHighestDepth();
		...
		clip = m_drawClip.createEmptyMovieClip("cellImageRep" + level, level);
		...
		fakeView.createBoundsTextField = (new NSView()).createBoundsTextField;

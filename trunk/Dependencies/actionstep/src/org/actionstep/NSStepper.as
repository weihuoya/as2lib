...
class org.actionstep.NSStepper extends NSControl {
	...
	/**
	 * Either increases or decreases current value of the control. Its behaviour
	 * is controlled by <code>dir</code>, or the "direction" of change, ie.
	 * up (increase) or down (decrease).
	 *
	 * This function should be private, but if it was, <code>NSStepperCell</code>
	 * won't be able to change its value. Thus the "$" prefix.
	 */

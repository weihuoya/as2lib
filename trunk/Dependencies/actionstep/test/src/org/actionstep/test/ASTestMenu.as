...
class org.actionstep.test.ASTestMenu {
	...
	public static function test():Void {
		var holder:MovieClip = _root.createEmptyMovieClip("assets", _root.getNextHighestDepth());
		var loader:ASTestLogo = new ASTestLogo(holder);
		var inst:ASTestMenu = new ASTestMenu();
		loader.setTarget(inst);
		loader.setSelector("start");

		loader.initWithLocationSymbol("test/logo.swf", "actionstep_logo");
	}
...
//	public static function notify(n:NSNotification):Void {
//		trace(n, ASDebugger.NONE);
//	}

...
class org.bugtracker.view.TicketPropertiesView extends NSView {
	...
	private var m_comment:ASTextEditor;
	...
	private function createTypeField():NSView {
		...
		m_type.addItemsWithObjectValues(Ticket.TYPE_STRINGS);
	...
	private function createPriorityField():NSView {
		...
		m_priority.addItemsWithObjectValues(Ticket.PRIOR_STRINGS);
	...
	private function createSeverityField():NSView {
		...
		m_severity.addItemsWithObjectValues(Ticket.SEV_STRINGS);
	...
	private function populateForm():Void {
		...
		m_comment.setHtmlString(m_ticket.comment());

...
class org.aswing.FocusManager{
	...
	//can override this method to change isTraversing() perform
	private function __noticeWhenKeyDown():Void{
		traversing = true;
	}
	//can override this method to change isTraversing() perform
	 ...
	 * If this method called, TAB... keys will not effect the focus traverse.
	 */
	 ...
	 * If this method called, TAB... keys will effect the focus traverse.
	 */

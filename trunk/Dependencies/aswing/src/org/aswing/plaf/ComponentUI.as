...
class org.aswing.plaf.ComponentUI{
    ...
    public function paintFocus(c:Component, g:Graphics):Void{
    	...
    	g.drawRectangle(new Pen(new ASColor(0x40FF40, 30), 1), 0.5, 0.5, dim.width-1, dim.height-1);
    	g.drawRectangle(new Pen(new ASColor(0x40FF40, 50), 1), 1.5, 1.5, dim.width-3, dim.height-3);
    }

...
class org.aswing.plaf.ComponentUI{
    ...
    public function paintFocus(c:Component):Void{
    	...
    	c.getFocusGraphics().drawRectangle(new Pen(new ASColor(0x40FF40, 90), 2), 0.5, 0.5, dim.width-1, dim.height-1);
    	c.getFocusGraphics().drawRectangle(new Pen(new ASColor(0x40FF40, 40), 1), 1.5, 1.5, dim.width-3, dim.height-3);
    }

...
class org.aswing.AbstractListModel{
    ...
    private function fireContentsChanged(target:Object, index0:Number, index1:Number):Void
    {
		var e:ListDataEvent = new ListDataEvent(target, ListDataEvent.CONTENTS_CHANGED, index0, index1);
    ...
    private function fireIntervalRemoved(target:Object, index0:Number, index1:Number):Void
    {
		var e:ListDataEvent = new ListDataEvent(target, ListDataEvent.INTERVAL_REMOVED, index0, index1);

...
class org.aswing.ElementCreater{
	...
	private var _defaultTextField:Object={tabEnabled:false, autoSize:"center", embedFonts:false, selectable:false, textColor:0xB333C};	
	...
	public function createMCWithName(position_mc:MovieClip, name:String, depth:Number):MovieClip{
		if(depth == undefined) depth = position_mc.getNextHighestDepth();

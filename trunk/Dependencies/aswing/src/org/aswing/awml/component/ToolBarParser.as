...
class org.aswing.awml.component.ToolBarParser extends ContainerParser {
	...
	public function parse(awml:XMLNode, bar:JToolBar):JToolBar {
		if (bar == null) {
			bar = new JToolBar();	
		}
	...
	private function parseChild(awml:XMLNode, nodeName:String, bar:JToolBar):Void {

		super.parseChild(awml, nodeName, bar);

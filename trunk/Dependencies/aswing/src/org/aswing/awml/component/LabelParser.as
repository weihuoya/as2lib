...
class org.aswing.awml.component.LabelParser extends ComponentParser {
    ...
    public function parse(awml:XMLNode, label:JLabel):JLabel {
    	
    	if (label == null) {
    		label = new JLabel();	
    	} 
    	
        super.parse(awml, label);
    ...
    private function parseChild(awml:XMLNode, nodeName:String, label:JLabel):Void {
    	super.parseChild(awml, nodeName, label);

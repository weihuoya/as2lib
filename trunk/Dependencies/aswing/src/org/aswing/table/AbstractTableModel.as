...
//
     ...
     *
     */
    public function fireTableRowsInserted(firstRow:Number, lastRow:Number):Void {
     ...
     * @see EventListenerList
     */
    public function fireTableRowsUpdated(firstRow:Number, lastRow:Number):Void {
        fireTableChanged(new TableModelEvent(this, firstRow, lastRow,
     ...
     * @see EventListenerList
     */
    public function fireTableRowsDeleted(firstRow:Number, lastRow:Number):Void {
        fireTableChanged(new TableModelEvent(this, firstRow, lastRow,
     ...
     * @see EventListenerList
     */
    public function fireTableCellUpdated(row:Number, column:Number):Void {

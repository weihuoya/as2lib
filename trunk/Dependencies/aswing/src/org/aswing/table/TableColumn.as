...
class org.aswing.table.TableColumn extends EventDispatcher{
	...
	public function setHeaderRenderer(headerRenderer:TableCellFactory):Void{
		var old:TableCellFactory = this.headerRenderer;
		this.headerRenderer = headerRenderer;
		firePropertyChange("headerRenderer", old, headerRenderer);
	}
	
	public function getHeaderRenderer():TableCellFactory{
		return headerRenderer;
	}
	
	public function setCellRenderer(cellRenderer:TableCellFactory):Void{
		var old:TableCellFactory = this.cellRenderer;
		this.cellRenderer = cellRenderer;
		firePropertyChange("cellRenderer", old, cellRenderer);
	}
	
	public function getCellRenderer():TableCellFactory{
		return cellRenderer;
	}

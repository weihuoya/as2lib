...
/**
 * Contentwrapper for a change-type tag.
 * 
 * @author Martin Heidegger
 */
class org.as2lib.tool.changelog.node.ChangeTypeNode extends BasicClass {
	...
	/**
	 * Creates a new ChangeTypeNode.
	 *
	 * @param node XMLNode that represents the xmlnode.
	 */
	public function ChangeTypeNode(node:XMLNode) {

...
import org.as2lib.test.unit.stringifier.UnexpectedExceptionStringifier;
import org.as2lib.util.string.Stringifier;

/**
 * Exception to be thrown if a Exception occurs during set up of a testcase.
 *
 * @autor Martin Heidegger
 * @date 16.11.2003
 */
 
class org.as2lib.test.unit.error.UnexpectedException extends Exception implements AssertException {
	
	// Stringifier holder for the class.
	private static var stringifier:Stringifier = new UnexpectedExceptionStringifier();
	
	/**
	 * Constructs a new Unexpected Exception.
	 * 
	 * @param message Message appended to the failure.
	 * @param thrower Thrower of the Exception
	 * @parma args Argument of the method
	 */
	function UnexpectedException (message:String, thrower, args) {

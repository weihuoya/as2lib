...
import org.as2lib.test.unit.stringifier.AssertIsInfinityStringifier;
 ...
 */
class org.as2lib.test.unit.error.AssertIsInfinityException extends Exception implements AssertException {
	/** Stringifier for the TestCase */
	private static var stringifier:Stringifier = new AssertIsInfinityStringifier();
		
	/** Container for the wrong variable */
	private var wrongVar;
	
	/**
	 * Constructs a new AssertIsInfinity exception.
	 * 
	 ...
	 * @param wrongVar	Variable that was not Infinity.
	 */
	public function AssertIsInfinityException (message:String, thrower, arguments:FunctionArguments, wrongVar) {
	...
	/**
	 * Returns the value that was not Infinity.
	 * 

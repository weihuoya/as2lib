...
import org.as2lib.test.unit.stringifier.AssertIsEmptyStringifier;
import org.as2lib.util.string.Stringifier;

/**
 * @autor Martin Heidegger.
 */
class org.as2lib.test.unit.error.AssertIsEmptyException extends Exception implements AssertException {
	/** Stringifier for the TestCase */
	private static var stringifier:Stringifier = new AssertIsEmptyStringifier();
		
	/** Container for the wrong variable */
	private var wrongVar;
	
	/**
	 * Constructs a new AssertIsEmpty exception.
	 * 
	 ...
	 */
	public function AssertIsEmptyException (message:String, thrower, arguments:FunctionArguments, wrongVar) {

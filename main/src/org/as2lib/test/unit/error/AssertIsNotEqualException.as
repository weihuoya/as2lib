 ...
 */
class org.as2lib.test.unit.error.AssertIsNotEqualException extends BasicClass implements AssertException {
	 ...
	 */
	public function AssertIsNotEqualException (message:String, wrongVar) {

 ...
 * This implementation simply refers the log messages to the output console.
 *
 * @author Martin Heidegger
 */
class org.as2lib.env.log.logger.TraceLogger extends BasicClass implements Logger, ConfigurableHierarchicalLogger {
	...
	public function log(message, level:LogLevel):Void {
		if (isEnabled(level)) {
			trace(new LogMessage(message, level));
		}
	}

...
/**
 * NoSuchPropertyException gets thrown to indicate that the property that
 * has been searched for is not declared on the specific class.
 *
 * @author Simon Wacker
 */
class org.as2lib.env.reflect.NoSuchPropertyException extends ReflectionException {
	...
	/**
	 * Constructs a new NoSuchPropertyException instance.
	 *

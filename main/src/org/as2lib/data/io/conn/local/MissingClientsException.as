 ...
 */
class org.as2lib.data.io.conn.local.MissingClientsException extends LocalServerException {
	/**
	 * @see org.as2lib.env.except.Exception#Constructor()
	 */
	public function MissingClientsException(message:String, thrower, args:FunctionArguments) {

...
/**
 * Contentwrapper for a change-arguments tag.
 * 
 * @author Martin Heidegger
 */
class org.as2lib.tool.changelog.node.ChangeArgumentsNode extends BasicClass {
	...
	/**
	 * Creates a new ChangeArgumentsNode.
	 *
	 * @param node XMLNode that represents the xmlnode.
	 */
	public function ChangeArgumentsNode(node:XMLNode) {
